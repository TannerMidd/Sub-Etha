    ...
    return (
        ...
        >
            ...
            <span className="room-list-item__copy">
                ...
                <small>
                    {room.membership === "invite" ? "Invitation waiting" : room.lastMessage}
                </small>
            </span>
                ...
                <div className="room-sidebar__body">
                    ...
                    <div className="room-column">
                        <div className="room-column__header">
                            <span>
                                <strong>{roomScope === "all" ? "Rooms" : roomScope}</strong>
                                <small>{filteredRooms.length} tuned</small>
                            </span>
                            <div>
                                <button
                                    type="button"
                    ...
                    <>
                        <header className="conversation-header">
                            ...
                            <div className="conversation-commands">
                                ...
                                <button
                                    type="button"
                                    aria-label={`${activeRoom.memberCount} members`}
                                    onClick={() => setDialog("details")}
                                >
                                    <Users />
                                    <span>Members</span>
                                    <small>{activeRoom.memberCount}</small>
                                </button>
                                <button
                                    type="button"
                        ...
                        {activeRoom.membership === "invite" ? (
                            <div className="invite-view">
                                <div className="invite-card">
                                    ...
                                    <p>
                                        The room would like to contain you. This is more courteous
                                        than most rooms manage.
                                    </p>
                                    <div>
                                        <button
                            ...
                            <>
                                <div className="conversation-stage">
                                    ...
                                    <aside className="receiver-field-guide" aria-hidden="true">
                                        ...
                                        <img
                                            className="receiver-field-guide__dark"
                                            src="/night-receiver-plate.png"
                                            alt=""
                                        />
                                        {/* eslint-disable-next-line @next/next/no-img-element -- Generated decorative brand plate. */}
                                        <img
                                            className="receiver-field-guide__light"
                                            src="/og.png"
                                            alt=""
                                        />
                                    ...
                                    {snapshot.typingNames.length ? (
                                        <>
                                            ...
                                            <span>
                                                ...
                                                {snapshot.typingNames.length === 1 ? "is" : "are"}{" "}
                                                typing…
                                            </span>
                                        </>
                                    ) : null}
